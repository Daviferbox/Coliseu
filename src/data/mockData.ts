...
export const mockChampionships = [
  ...
  // ── 1. ELIMINATÓRIA SIMPLES ─────────────────────────────
  {
    ...
    dataProximoJogo: "2026-05-25T15:00:00",
  ...
  // ── 2. ROUND ROBIN ──────────────────────────────────────
  {
    ...
    dataProximoJogo: "2026-05-28T18:00:00",
  ...
  // ── 3. FASE DE GRUPOS + MATA-MATA ───────────────────────
  {
    ...
    dataProximoJogo: "2026-06-03T14:00:00",
    disponivelParaInscricao: true,
    status: "inscricoes_abertas",
    rank: "Platina",
  ...
  // ── 4. CHAVE DUPLA (DOUBLE ELIMINATION) ─────────────────
  {
    ...
    dataProximoJogo: "2026-06-10T19:00:00",
    disponivelParaInscricao: false,
    status: "em_andamento",
    rank: "Bronze",
  ...
  // ── 5. SISTEMA SUÍÇO ────────────────────────────────────
  {
    ...
    dataProximoJogo: "2026-06-15T16:00:00",
    disponivelParaInscricao: true,
    status: "inscricoes_abertas",
    rank: "Diamante",
    formato: "swiss",
